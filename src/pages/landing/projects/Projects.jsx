...
import EbuteImg from "../../../assests/projectImgs/EbuteImg.png";
import ErpImg from "../../../assests/projectImgs/ErpImg.png";
import TraceImg from "../../../assests/projectImgs/TraceImg.png";
        ...
        {projects.map((item, index) => (
          ...
          >
            <div className="flex items-start md:items-center">
              ...
              <h4 className="flex flex-col md:flex-row md:items-center text-xl md:text-2xl lg:text-3xl">
            ...
            <img
              ...
              className={`w-96 h-auto absolute top-1/2 right-[10%] -translate-y-1/2 transition-opacity duration-300 z-50 bg-black rounded-xl p-4 ${
