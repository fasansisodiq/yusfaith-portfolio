...
function QuoteCard({ name, position, quote, src }) {
  return (
    <div
      className={` shake-element  flex flex-col justify-center gap-15  lg:gap-0 xl:gap-0 items-center perspective-origin-top-right`}
    >
      <img
        src={src}
      ...
      />
      <div className=" flex flex-col justify-center italic items-center gap-3 sm:gap-2  h-[16rem] w-[7.5rem] sm:w-[12rem] sm:h-[18rem] sm:pt-10 md:w-[14rem] md:h-[19rem] lg:w-[17rem] lg:h-[23rem] xl:w-[22rem] xl:h-[23rem] px-1 border border-slate-300 lg:pt-15 bg-stone-500/65 rounded-3xl bg-gradient-to-r  from-stone-500/65 from-10% via-stone-800 via-30% to-stone-500/65 to-70% ">
