  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full  h-full">
        ...
        <div className="slider-container w-40 h-8 sm:h-10 md:h-12 lg:h-14 xl:h-15 p-1 sm:w-80 md:w-96 lg:w-105 xl:w-150 flex flex-row justify-end items-center rounded-full border-2 border-slate-100  overflow-auto  [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
